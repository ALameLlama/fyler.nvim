...
T['Creates default configuration'] = function()
  ...
  expect_config('kind_presets.floating.mappings.n["<CR>"].desc', 'Open and close')
  ...
  expect_config('kind_presets.replace.mappings.n["<CR>"].desc', 'Open and close')
  ...
  expect_config('mappings.n["<BS>"].desc', 'Collapse parent directory')
  ...
  expect_config('mappings.n["<CR>"].desc', 'Open with window picker')
  expect_config('mappings.n["?"].action', 'show_help')
  expect_config('mappings.n["?"].desc', 'Show help')
  expect_config('mappings.n["-"].action', 'visit')
  expect_config('mappings.n["-"].args.parent', true)
  expect_config('mappings.n["-"].desc', 'Go to parent directory')
  expect_config('mappings.n["."].action', 'visit')
  expect_config('mappings.n["."].args.cursor', true)
  expect_config('mappings.n["."].desc', 'Enter directory under cursor')
  expect_config('mappings.n["="].action', 'visit')
  expect_config('mappings.n["="].desc', 'Go to root directory')
  expect_config('mappings.n["g."].action', 'toggle_ui')
  expect_config('mappings.n["g."].args', { 'hidden_items' })
  expect_config('mappings.n["g."].desc', 'Toggle hidden files')
  expect_config('mappings.n["gi"].action', 'toggle_ui')
  expect_config('mappings.n["gi"].args', { 'indent_guides' })
  expect_config('mappings.n["gi"].desc', 'Toggle indent guides')
  expect_config('mappings.n["q"].action', 'close')
  expect_config('mappings.n["q"].desc', 'Close finder')
