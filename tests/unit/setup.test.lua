...
T['Creates default configuration'] = function()
  ...
  expect_config('mappings.n["/"].desc', 'Search for files')
  ...
  expect_config('mappings.n["<CR>"].desc', 'Open')
